...
String _$logInWithSocialUseCaseHash() =>
    r'eb2a5906687041205745a2108f196337f45ac761';
...
typedef LogInWithSocialUseCaseRef = AutoDisposeFutureProviderRef<User>;
...
/// See also [logInWithSocialUseCase].
class LogInWithSocialUseCaseFamily extends Family<AsyncValue<User>> {
  /// See also [logInWithSocialUseCase].
...
/// See also [logInWithSocialUseCase].
class LogInWithSocialUseCaseProvider extends AutoDisposeFutureProvider<User> {
  /// See also [logInWithSocialUseCase].
